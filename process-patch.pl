...
while ($_ = <$git_fh>) {
    s[jdk\.internal\.javac\.PreviewFeature][io.smallrye.classfile.extras.PreviewFeature]g;
    s[java(.)lang.reflect.(AccessFlag|ClassFileFormatVersion)][io$1smallrye$1classfile$1extras$1reflect$1$2]g;
    s[java(.)lang.constant.(ModuleDesc|PackageDesc)][io$1smallrye$1classfile$1extras$1constant$1$2]g;
    s[jdk(.)internal.constant.(ModuleDescImpl|PackageDescImpl|ConstantUtils)][io$1smallrye$1classfile$1extras$1constant$1$2]g;
    ...
    s[java(.)lang.classfile][io$1smallrye$1classfile]g;
    s[jdk(.)internal.classfile][io$1smallrye$1classfile]g;
    s[(import jdk\.internal\.constant\.(ReferenceClass|PrimitiveClass|ClassOrInterface)DescImpl.*)][//$1]g;
    s[jdk(.)internal.constant][io$1smallrye$1classfile$1extras$1constant]g;
    s[package java\.lang\.reflect][package io.smallrye.classfile.extras.reflect]g;
    s[package java\.lang\.constant][package io.smallrye.classfile.extras.constant]g;
