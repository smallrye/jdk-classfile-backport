...
public sealed interface TypeAnnotation
     ...
     *         exceeds the limit of {@link io.github.dmlloyd.classfile##u1 u1}
     */
    ...
    sealed interface TargetInfo {
         ...
         *         {@link io.github.dmlloyd.classfile##u1 u1}
         */
         ...
         *         {@link io.github.dmlloyd.classfile##u2 u2}
         */
         ...
         *         {@code boundIndex} is not {@link io.github.dmlloyd.classfile##u1 u1}
         */
         ...
         *         not {@link io.github.dmlloyd.classfile##u1 u1}
         */
         ...
         *         not {@link io.github.dmlloyd.classfile##u2 u2}
         */
         ...
         *         exceeds the limit of {@link io.github.dmlloyd.classfile##u2 u2}
         */
