...
public sealed interface ModuleAttribute
     ...
     * io.github.dmlloyd.classfile##u2 u2} value.
     *
     ...
     *         io.github.dmlloyd.classfile##u2 u2} or any of the collections has a size
     *         over the limit of {@link io.github.dmlloyd.classfile##u2 u2}
     */
    ...
    public sealed interface ModuleAttributeBuilder
         ...
         *         the limit of {@link io.github.dmlloyd.classfile##u2 u2}
         */
