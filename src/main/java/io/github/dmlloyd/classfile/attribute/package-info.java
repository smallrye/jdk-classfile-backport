...
/**
 * <h2>Provides interfaces describing {@code class} file attributes for the {@link io.github.dmlloyd.classfile} library.</h2>
 *
 * The {@code io.github.dmlloyd.classfile.attribute} package contains interfaces describing specific {@code class} file
 ...
 * <p>
 * APIs in this package perform {@linkplain io.github.dmlloyd.classfile##checks null and unrepresentable argument checks},
 ...
 * io.github.dmlloyd.classfile.constantpool} for effective reading of constant pool entries, which can affect attribute reading
 ...
 * see "{@linkplain io.github.dmlloyd.classfile.constantpool##writing Writing the constant pool entries}" for more details.
 * <p>
