...
public sealed interface DiscontinuedInstruction extends Instruction {
     ...
     * }
     * where {@code slot} must be {@link io.github.dmlloyd.classfile##u2 u2}.
     * <p>
    ...
    sealed interface RetInstruction extends DiscontinuedInstruction
         ...
         * <p>
         * {@code slot} must be {@link io.github.dmlloyd.classfile##u1 u1} for
         * {@link Opcode#RET ret}, or {@link io.github.dmlloyd.classfile##u2 u2} for
