 ...
 * questions.
 */
package io.github.dmlloyd.classfile.snippets;
    ...
    void writeHelloWorld1() {
        ...
        byte[] bytes = ClassFile.of().build(CD_Hello,
                clb -> clb.withFlags(ClassFile.ACC_PUBLIC)
                          .withMethod(ExtraConstantDescs.INIT_NAME, ConstantDescs.MTD_void,
                                      ClassFile.ACC_PUBLIC,
                                      mb -> mb.withCode(
                                              cob -> cob.aload(0)
                                                        .invokespecial(ConstantDescs.CD_Object,
                                                                       ExtraConstantDescs.INIT_NAME, ConstantDescs.MTD_void)
                                                        .return_()))
