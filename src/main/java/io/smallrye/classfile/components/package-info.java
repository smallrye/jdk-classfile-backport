 ...
 * {@link io.smallrye.classfile} library.</h2>
 *
 * The {@code io.smallrye.classfile.components} package contains specific
 ...
 * io.smallrye.classfile.ClassModel}, {@link io.smallrye.classfile.FieldModel},
 * {@link io.smallrye.classfile.MethodModel}, or {@link
 * io.smallrye.classfile.CodeModel} into human-readable structured text in
 ...
 * ClassRemapper is a {@link io.smallrye.classfile.ClassTransform}, {@link
 * io.smallrye.classfile.FieldTransform}, {@link
 * io.smallrye.classfile.MethodTransform} and {@link
 * io.smallrye.classfile.CodeTransform} deeply re-mapping all class references
 ...
 * {@link CodeLocalsShifter} is a {@link io.smallrye.classfile.CodeTransform}
 ...
 * {@link CodeRelabeler} is a {@link io.smallrye.classfile.CodeTransform}
 * replacing all occurrences of {@link io.smallrye.classfile.Label} in the
 * transformed code with new instances.
 * All {@link io.smallrye.classfile.instruction.LabelTarget} instructions are
 ...
 * of {@link io.smallrye.classfile.Label} is bound in the target bytecode
 * exactly once.
 * <p>
