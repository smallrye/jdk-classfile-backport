 ...
 * questions.
 */
package io.smallrye.classfile.components.snippets;
...
import io.smallrye.classfile.components.CodeLocalsShifter;
import io.smallrye.classfile.components.CodeRelabeler;
                    ...
                    clb.transform(instrumentor,
                            ClassTransform.dropping(cle ->
                                    ...
                                    && !(cle instanceof MethodModel mm
                                            && !ExtraConstantDescs.INIT_NAME.equals(mm.methodName().stringValue())
