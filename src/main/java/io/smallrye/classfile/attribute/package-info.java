...
/**
 * <h2>Provides interfaces describing {@code class} file attributes for the {@link io.smallrye.classfile} library.</h2>
 *
 * The {@code io.smallrye.classfile.attribute} package contains interfaces describing specific {@code class} file
 ...
 * <p>
 * APIs in this package perform {@linkplain io.smallrye.classfile##checks null and unrepresentable argument checks},
 ...
 * io.smallrye.classfile.constantpool} for effective reading of constant pool entries, which can affect attribute reading
 ...
 * see "{@linkplain io.smallrye.classfile.constantpool##writing Writing the constant pool entries}" for more details.
 * <p>
