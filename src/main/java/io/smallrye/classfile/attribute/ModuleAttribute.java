...
import io.smallrye.classfile.impl.ModuleAttributeBuilderImpl;
...
public sealed interface ModuleAttribute
     ...
     * io.smallrye.classfile##u2 u2} value.
     *
     ...
     *         io.smallrye.classfile##u2 u2} or any of the collections has a size
     *         over the limit of {@link io.smallrye.classfile##u2 u2}
     */
    ...
    public sealed interface ModuleAttributeBuilder
         ...
         *         the limit of {@link io.smallrye.classfile##u2 u2}
         */
         ...
         *         limit of {@link io.smallrye.classfile##u2 u2}
         */
