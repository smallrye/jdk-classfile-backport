...
import io.smallrye.classfile.impl.ClassFileVersionImpl;
...
public sealed interface ClassFileVersion
    ...
    /**
     * {@return the major version}  It is a {@link io.smallrye.classfile##u2 u2}
     * value.
     *
     * @apiNote
    ...
    /**
     * {@return the minor version}  It is a {@link io.smallrye.classfile##u2 u2}
     * value.
     */
    int minorVersion();
     ...
     *         version is not {@link io.smallrye.classfile##u2 u2}; the minor
