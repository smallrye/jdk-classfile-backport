...
import io.smallrye.classfile.impl.TargetInfoImpl;
import io.smallrye.classfile.impl.UnboundAttribute;
import io.smallrye.classfile.impl.Util;

import static io.smallrye.classfile.TypeAnnotation.TargetInfo.*;
...
public sealed interface TypeAnnotation
     ...
     *         exceeds the limit of {@link io.smallrye.classfile##u1 u1}
     */
    ...
    sealed interface TargetInfo {
         ...
         *         {@link io.smallrye.classfile##u1 u1}
         */
         ...
         *         {@link io.smallrye.classfile##u2 u2}
         */
         ...
         *         {@code boundIndex} is not {@link io.smallrye.classfile##u1 u1}
         */
         ...
         *         not {@link io.smallrye.classfile##u1 u1}
         */
         ...
         *         not {@link io.smallrye.classfile##u2 u2}
         */
         ...
         *         exceeds the limit of {@link io.smallrye.classfile##u2 u2}
         */
    ...
    sealed interface ThrowsTarget extends TargetInfo
         ...
         *
         * @return the index into the list io.smallrye.classfile.attribute.ExceptionsAttribute.exceptions()
         */
