...
/**
 * <h2>Provides interfaces describing code instructions for the {@link io.smallrye.classfile} library.</h2>
 *
 * The {@code io.smallrye.classfile.instruction} package contains interfaces describing code instructions.
