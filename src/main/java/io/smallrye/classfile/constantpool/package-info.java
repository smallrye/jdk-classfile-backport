...
/**
 * <h2>Provides interfaces describing constant pool entries for the {@link io.smallrye.classfile} library.</h2>
 *
 * The {@code io.smallrye.classfile.constantpool} package contains interfaces describing constant pool entries in the
